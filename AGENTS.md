...
Shared guidance for Codex in this repo.
...
- Run relevant tests or checks when practical; say clearly if they cannot be run.
- Save durable decisions, gotchas, and next actions in `docs/ai-notes/` when useful.
